...
import type { FullCourseInfo, InsertCourseInfo } from "../../domain/types.js";

export interface ICourseInfoRepository {
    insertCourseInfo: (courseCode: string, name: string, canvasCourseId: number, rawSyllabus: string, tabs: CanvasTab[], courseId: number) => Promise<InsertCourseInfo>;
