...
import { IngestionScope } from "./Ingestion.scope.js";
...
export class AppContainer {
    ...
    constructor(
        ...
        this.repos = {
            ...
            ingestionRun: new DrizzleIngestionRunRepository(this.db),
        };
    ...
    createIngestionScope(ctx: Context) {
        return new IngestionScope(ctx, this.repos, this.queues);
    }
};